...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml \
...
# Vendor init
$(call soong_config_set,libinit,vendor_init_lib,//$(LOCAL_PATH):libinit.xiaomi_8996)
